...
class CompositeLikelihood(Likelihood):
    ...
    Args:
        like_list (list): list of `Sun-Corona-Syn.likelihood.RVLikelihood` objects
    """
...
class RVLikelihood(Likelihood):
    ...
    The Likelihood object for a Sun-Corona-Syn velocity dataset

    Args:
        model (Sun-Corona-Syn.model.RVModel): RV model object
        t (array): time array
