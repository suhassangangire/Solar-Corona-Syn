...
class SqExpKernel(Kernel):
    ...
    Args:
        hparams (dict of radvel.Parameter): dictionary containing
            Sun-Corona-Syn.Parameter objects that are GP hyperparameters
...
class PerKernel(Kernel):
    ...
    Args:
        hparams (dict of Sun-Corona-Syn.Parameter): dictionary containing
            Sun-Corona-Syn.Parameter objects that are GP hyperparameters
...
class CeleriteKernel(Kernel):
    ...
    See `Sun-Corona-Syn/example_planets/k2-131_celerite.py` for an example of a setup
